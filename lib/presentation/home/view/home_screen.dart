                            ...
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(() => Text(
                                        homeController.getHourTemperature(
                                            homeController.hourData.hourly!
                                                .temperature_2m[start],
                                            homeController.selectedUnit
                                                .value), // Display the temperature with the updated unit
                                        style: GoogleFonts.openSans(
                                          fontSize: 45.0,
                                          color: const Color(0xFFFFFFFF)
                                              .withOpacity(0.7),
